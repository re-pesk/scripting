...
declare -A MESSAGES=(
  ...
  'lt_LT.UTF-8.missing_chksum_fname' 'Klaida! Nepateiktas patikros sumos failo pavadinimas!'
  'lt_LT.UTF-8.missing_checksum_type' 'Klaida! Nepateiktas patikros sumos tipas!'
