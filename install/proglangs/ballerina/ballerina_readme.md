...
Jeigu nėra įdiegta, įdiekite [curl](../../misc/curl/curl.md), unzip ir xargs (findutils).
...
ln -frsT "${HOME}/.bin/app-launcher" "${HOME}/.bin/bal"

# Sukurti įrašus faile .app_map
grep -qF 'bal:ballerina' "${HOME}/.app_map" || printf $'bal:ballerina\n' >> "${HOME}/.app_map"
